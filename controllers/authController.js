...
exports.restrictTo = (...roles) =>{
    return(req,res,next) =>{
        ...
        if(!roles.includes(req.user.role)){
            return next(new AppError('You do not have permission to perform his action', 403));
        }
...
exports.forgotPassword = catchAsync(async (req,res,next) =>{
    ...
    try{
        ...
        return new(new AppError('There was an error sending the email! Try again later!', 500)); 
    }
